...
def test_good_case_sum_of_squares_and_square_of_sums(test_x, test_y, expected_result) -> None:
    assert sum_of_squares_and_square_of_sums(x=test_x, y=test_y) == expected_result
...
def test_good_case_large_number(test_a, test_b, test_d, test_c, expected_result) -> None:
    assert large_number(a=test_a, b=test_b, c=test_c, d=test_d) == expected_result
...
def test_good_case_reproduction_of_n(test_number, expected_result) -> None:
